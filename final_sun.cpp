...
char str6[]="ON";
glColor3f(1,0,0);
glRasterPos2f(460,335);
for(k=0;k<strlen(str6);k++)
{
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str6[k]);
        }

char str16[]="SUNRISE AND SUNSET";
glColor3f(1,1,0);
glRasterPos2f(350,310);
for(k=0;k<strlen(str16);k++)
{
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str16[k]);
        }

char str7[]="TEAM MEMBERS";
glColor3f(1,0,0);
glRasterPos2f(120,220);
for(k=0;k<strlen(str7);k++)
{
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,str7[k]);
        }

char str8[]="Swasthika 4MT19CS167";
glColor3f(2,0.5,1);
...
char str9[]="Joyline Claudia Machado  4MT20CS400";
glColor3f(2,0.5,1);
...
void myKeys(unsigned char k,int x,int y)
{
	if(k=='s'||k=='S' || k== 13 )
	{
		fscreen=0;
